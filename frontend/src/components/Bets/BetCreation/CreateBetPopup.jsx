...
// this theme is used to style the menu items
...
/**
 * The popup used when a user clicks create a bet
 */
export default class CreateBetPopup extends Component {
    ...
    /**
     * ComponentDidUpdate in this component is used to watch the category index
     * When the category changes, it determines what needs to be done with the minutes state array
     * Since the array for minutes is bigger when the user is betting between 2 different times
     */
    ...
    render () {
        return (
            <ThemeProvider theme={theme}>
                ...
                >
                    ...
                    <FlexBoxRow width='500px' height='308px'>
                        <FlexBoxColumn width='60%'>
                            ...
                            {/* Select the category for your bet */}
                        ...
                        {/* Seperate the left and right side */}
                        ...
                        {/* Select a match on the date you previously selected */}
                    ...
                    {/* Minutes input and payout calculation at the bottom */}
                ...
                {/* Opened when the user clicks the submit button */}
                <ConfirmationBox

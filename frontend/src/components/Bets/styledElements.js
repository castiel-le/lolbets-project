    ...
    if (props.left) {
        return (
            <FlexBoxRow width='40%' sx={{ alignItems: 'center' }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', alignContent: 'center', marginLeft: 'auto' }}>
        ...
        return (
            <FlexBoxRow width='40%' sx={{ alignItems: 'center' }}>
                <TeamLogo my='auto' src={props.team.logo} />
                <Box sx={{ display: 'flex', flexDirection: 'column', alignContent: 'center', marginRight: 'auto' }}>

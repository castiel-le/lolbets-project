...
/**
 * Determines the payout of a custom bet based on the input minutes
 * @param minutes the mintues the user wants to bet
 * @param categoryIndex the index of the category the user wants to bet on (index of category array)
 */
export default function payout({minutes, categoryIndex}) {
    const [payout, setPayout] = useState(['-', '-', '-']);

    /**
     * Whenever mintutes changes, fetch a new payout to display
     */
    useEffect(() => {

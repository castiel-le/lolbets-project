...
import { FlexBoxColumn, FlexBoxRow, TypographyLight, TypographyMedium, HorizontalDivider } from "../customUIComponents";
    ...
    render(){
        return (
            ...
            <FlexBoxColumn sx={{ width: '20%', backgroundColor: '#444bc7', padding: '0 5px 5px 5px', borderRadius: '5px', alignItems: 'center', height: '91%'}}>
                ...
                <FlexBoxRow sx={{ width: '100%', backgroundColor: 'rgb(238, 90, 82)', height: '10%', borderRadius: '5px'}}>

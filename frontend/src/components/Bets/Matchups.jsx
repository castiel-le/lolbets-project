...
/**
 * The matchups tab, handles the logic for how to display matchups and when the user clicks the bet
 */
class Matchups extends Component {
    ...
    /**
     * Only rerender the view if one of these 3 props changes
     * This is to reduce performance issues from rerendering all the time
     */
